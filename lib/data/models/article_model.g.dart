    ...
    if (value != null) {
      bytesCount += 3 +
          SourceModelSchema.estimateSize(
              value, allOffsets[SourceModel]!, allOffsets);
    }
  }
  {
...
void _articleModelSerialize(
  ...
  writer.writeString(offsets[10], object.urlToImage);
}
...
ArticleModel _articleModelDeserialize(
  ...
  final object = ArticleModel(
    ...
    publishedAt: reader.readStringOrNull(offsets[6]),
    ...
    urlToImage: reader.readStringOrNull(offsets[10]),
  );
  object.id = id;
  return object;
}
...
extension ArticleModelQueryObject
    on QueryBuilder<ArticleModel, ArticleModel, QFilterCondition> {
  QueryBuilder<ArticleModel, ArticleModel, QAfterFilterCondition> source(
...
extension ArticleModelQuerySortBy
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByCountry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'country', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByCountryDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQuerySortThenBy
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'category', Sort.desc);
    });
  }
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByCountry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'country', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByCountryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'country', Sort.desc);
    });
  }
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByHashCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.asc);
    });
  }

  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByHashCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hashCode', Sort.desc);
    });
  }
...
extension ArticleModelQueryWhereDistinct
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctByCountry(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctByHashCode() {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQueryProperty
  ...
  QueryBuilder<ArticleModel, String?, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, String?, QQueryOperations> countryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, int, QQueryOperations> hashCodeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ArticleModel, SourceModel?, QQueryOperations> sourceProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension SourceModelQueryFilter
  ...
  QueryBuilder<SourceModel, SourceModel, QAfterFilterCondition> hashCodeEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hashCode',
  ...
  QueryBuilder<SourceModel, SourceModel, QAfterFilterCondition> hashCodeBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
